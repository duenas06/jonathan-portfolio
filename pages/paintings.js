  ...
  return (
    ...
    <main>
      <Container maxW="container.lg">
        ...
        <Text fontSize="5.5vw" opacity="10%" marginBottom={"-3.8vh"} letterSpacing={10}>PAINTINGS</Text>
        :
        <Text fontSize="5.5vw" opacity="10%" marginBottom={"-3.8vh"} letterSpacing={10}>PAINTINGS</Text>}

            <ImageList sx={{ overflow:"hidden",width: 480, height: 400 }} cols={3} rowHeight={214}>
            {Pics.map((item) => (
